...
for var in ${vararray[*]}; do
    if [[ "$var" = "zg" ]] || [[ "$var" = "ua" ]] || [[ "$var" = "tas" ]] || [[ "$var" = "clt" ]] || [[ "$var" = "pr" ]] || [[ "$var" = "rlut" ]] || [[ "$var" = "uas" ]] || [[ "$var" = "vas" ]]; then
        ...
        if [[ "$var" = "zg" ]]; then
            cdo -remap,r180x91,weights_unstr_2_r180x91_${var}.nc -selname,${var} -setgrid,$atm_gridfile_path -sellevel,50000 -seltimestep,$steps $var ${var}_${model}_198912-201411.nc &
        elif [[ "$var" = "ua" ]]; then
            cdo -remap,r180x91,weights_unstr_2_r180x91_${var}.nc -selname,${var} -setgrid,$atm_gridfile_path -sellevel,30000 -seltimestep,$steps $var ${var}_${model}_198912-201411.nc &
        else
            cdo -remap,r180x91,weights_unstr_2_r180x91_${var}.nc -selname,${var} -setgrid,$atm_gridfile_path -seltimestep,$steps $var ${var}_${model}_198912-201411.nc &
        fi
    else
