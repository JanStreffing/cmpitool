base="/pool/data/CMIP6/data/CMIP/E3SM-Project/E3SM-1-1/historical/r1i1p1f1//"
model="E3SM-1-1"
vararray=("siconc" "tas" "ua" "zg" "clt" "pr" "rlut" "uas" "vas")
mode="fiveyearly" #onefile, yearly, decadal, five, four
