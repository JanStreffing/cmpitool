base="/pool/data/CMIP6/data/CMIP/HAMMOZ-Consortium/MPI-ESM-1-2-HAM/historical/r1i1p1f1/"
model="HAMMOZ"
vararray=("zg" "ua" "siconc" "tas" "clt" "pr" "rlut" "uas" "vas")
mode="three" #onefile, yearly, decadal, five, four
