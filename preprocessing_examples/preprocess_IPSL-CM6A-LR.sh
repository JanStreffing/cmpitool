base="/pool/data/CMIP6/data/CMIP/IPSL/IPSL-CM6A-LR/historical/r1i1p1f1/"
model="IPSL-CM6A-LR"
vararray=("siconc" "ua" "zg" "tas" "clt" "pr" "rlut" "uas" "vas")
...
vararray=("zg" "ua")
mode="75" #onefile, yearly, decadal, five, four
